...
public class DeleteIntroController extends Menu.PatientLinkedList{
    ...
    public void searchPatientName(ActionEvent actionEvent) throws IOException{
        ...
        if(searchedName.equals("")){
            ...
            AnchorPane nextAnchorPane = FXMLLoader.load(getClass().getResource("DeleteUI.fxml"));
            DeleteIntroAnchor.getChildren().setAll(nextAnchorPane);
        }
    }
